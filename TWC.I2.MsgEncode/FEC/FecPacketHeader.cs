...
// Type: TWC.I2.MsgEncode.FEC.FecPacketHeader
...
namespace TWC.I2.MsgEncode.FEC
{
  public class FecPacketHeader
  {
    ...
    public void Set(uint packetId, FecEncoding encoding, byte minGridWidth, byte maxGridWidth, uint filesize)
    {
    ...
    {
      return this.Encoding() == FecEncoding.None || this.PacketId() <= 4U || (int) (this.PacketId() % 2U) == 1;
    }
    ...
    public static bool Find(Stream stream, ushort packetSize, out FecEncoding encoding, out uint filesize, out byte minGridWidth, out byte maxGridWidth)
    {
