...
// Type: TWC.I2.MsgEncode.FEC.Decoder.Version1
...
namespace TWC.I2.MsgEncode.FEC.Decoder
{
  internal class Version1 : FecDecoder
  {
    ...
    public Version1(Stream inputStream, ushort packetSize, uint filesize, byte minGridWidth, byte maxGridWidth)
    ...
    {
      if ((int) this.decodebuffercount == 2)
      {
      ...
      else if ((int) this.decodebuffercount == 3)
      {
