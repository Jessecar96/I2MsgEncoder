...
// Type: TWC.I2.MsgEncode.FEC.FecEncoder
...
namespace TWC.I2.MsgEncode.FEC
{
  public abstract class FecEncoder
  {
    ...
    public static uint EncodeFile(FecEncoding encoding, ushort packetSize, byte minGridWidth, byte maxGridWidth, string fname)
    {
    ...
    public static uint EncodeFile(FecEncoding encoding, ushort packetSize, byte minGridWidth, byte maxGridWidth, string fname, string tempFolder)
    {
    ...
    public static FecEncoder Create(FecEncoding encoding, ushort packetSize, byte minGridWidth, byte maxGridWidth)
    {
      switch (encoding)
      {
    ...
    protected FecEncoder(FecEncoding encoding, ushort packetSize, byte minGridWidth, byte maxGridWidth)
    {
